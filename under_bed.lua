...
forgotten_letter = obj {
	...
	tak = 'Кое-как вам удается дотянуться и забрать бумажку себе. Это письмо.',
};
...
twinkles = obj {
	...
	act = function(s)
		p [[Вы тянете руку к огоньками и слышите тихий писк и шуршание. Видимо где-то в стене под кроватью у мышки норка.]]
		s:remove();
	end;
};
